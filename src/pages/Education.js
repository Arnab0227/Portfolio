...
export default function Education() {
  ...
  const [ref1, schoolInView] = useInView({
    triggerOnce: true,
    
  })
  const [ref2, highInView] = useInView({
    triggerOnce: true,
  })
  const [ref3, uniInView] = useInView({
    triggerOnce: true,
  ...
  useEffect(() => {
    if(schoolInView){
      console.log("ref1 inView:", schoolInView);
      setIsVisible(true)
    }
  },[schoolInView])
  ...
  useEffect(() => {
    if(highInView){
      console.log("ref2 inView:", highInView);
      setIsLaunch(true)
    }
  },[highInView])
  ...
  return (
    <div className=''>
        ...
        <div className='h-96 rounded-lg relative w-full mt-10 elevation-10'>
            ...
            <div ref={ref1} className={`text-left text-2xl lg:text-4xl space-y-5 pl-5 lg:pl-20 text-container ${isVisible ? 'slide-in' : ''}`}>
            <p>Secondary</p>
        ...
        <div className='h-96 rounded-lg relative w-full mt-10 elevation-10'>
            ...
            <div ref={ref2} className={`text-right text-2xl lg:text-4xl space-y-5 pr-5 lg:pl-20 text-containerRight ${isLaunch ? 'slide-in' : ''}`}>
        ...
        <div className='h-96 rounded-lg relative w-full mt-10 elevation-10'>
            ...
            <div className='absolute h-full w-2/3 top-0 left-0 bg-gradient-to-r from-black via-sky-700'></div>
            <div className='absolute h-full w-1/3 top-0 left-0 flex items-center justify-center text-white font-semibold'>
            <div ref={ref3} className={`text-left text-2xl lg:text-4xl space-y-5 pl-5 lg:pl-10 text-container ${isAppear ? 'slide-in' : ''}`}>
            <p>B.tech</p>
        ...
        <div className='relative h-screen w-full bg-black flex items-center justify-center elevation-10 mt-10' style={coronaImage}>
        ...
        <div ref={ref5} className='relative h-screen w-full bg-black flex items-center justify-center elevation-10 mt-10 mb-10' style={webDevImage}>
